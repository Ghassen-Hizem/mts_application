export default function Paymonth() {
    ...
    return (
        ...
        <h5 class="mb-4 text-xl font-extrabold text-gray-800 ">Standard plan</h5>
        ...
        <button type="button" class="text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-200 dark:focus:ring-blue-900 font-medium rounded-lg text-sm px-5 py-2.5 inline-flex justify-center w-full text-center">Pay with ETH</button>
    </div>
