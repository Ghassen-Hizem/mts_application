...
<footer class="p-4  sm:p-6 bg-gray-900">
    <div class="md:flex md:justify-between">
        ...
        <div class=" grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
                <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase text-white">Tools</h2>
                <ul class="text-gray-600 text-gray-400">
                    <li class="mb-4">
                        <a href="https://flowbite.com/" class="hover:underline">NextJs</a>
                    </li>
                    <li>
                        <a href="https://tailwindcss.com/" class="hover:underline">HardHat</a>
                    </li>
                </ul>
            </div>
            <div>
                ...
                <ul class="text-gray-600 text-gray-400">
                    <li class="mb-4">
                        <a href="https://github.com/Ghassen-Hizem/mts_application" class="hover:underline ">Github</a>
                    </li>
                    <li>
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <span class="text-sm text-gray-500 sm:text-center text-gray-400">© 2022 <a href="https://flowbite.com/" class="hover:underline">Gamversity</a>. All Rights Reserved.
        </span>
